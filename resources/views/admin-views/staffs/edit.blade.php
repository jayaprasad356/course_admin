...
@section('title', translate('Update staffs'))
<style>
    .password-container{
        position: relative;
    }
...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-edit"></i> {{translate('update staffs')}}</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
        <div class="row gx-2 gx-lg-3">
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <form action="{{route('admin.staffs.update',[$staffs['id']])}}" method="post"
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" value="{{$staffs['name']}}" class="form-control" placeholder="{{translate(' Name')}}"
                                    required>
                            </div>
                         </div>
                        <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <input type="text" name="email" value="{{$staffs['email']}}" class="form-control" placeholder="{{translate('email')}}"
                                 required>
                             </div> 
                         </div> 
                     </div>
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="mobile" value="{{$staffs['mobile']}}" class="form-control" placeholder="{{translate(' mobile')}}"
                                    required>
                            </div>
                         </div>
                        <div class="col-md-3">
                            <div class="form-group">
                              ...
                              <input type="text" name="password" value="{{$staffs['password']}}" class="form-control" placeholder="{{translate('password')}}"
                                 required>
                             </div> 
                         </div> 
                        <div class="col-md-3">
                           <div class="form-group">
                             ...
                             <input type="text" name="salary" value="{{$staffs['salary']}}" class="form-control" placeholder="{{translate('salary')}}"
                                required>
                            </div>
                        </div>
                        <div class="col-md-3">
                           <div class="form-group">
                             ...
                             <input type="date" name="dob" value="{{$staffs['dob']}}" class="form-control" placeholder="{{translate('date of birth')}}"
                                required>
                            </div>
                        </div>
                     </div>
                     <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="bank_name" value="{{$staffs['bank_name']}}" class="form-control" placeholder="{{translate(' bank_name')}}"
                                    required>
                            </div>
                         </div>
                        <div class="col-md-3">
                            <div class="form-group">
                              ...
                              <input type="text" name="branch" value="{{$staffs['branch']}}" class="form-control" placeholder="{{translate('branch')}}"
                                 required>
                             </div> 
                         </div> 
                        <div class="col-md-3">
                           <div class="form-group">
                             ...
                             <input type="text" name="bank_account_number" value="{{$staffs['bank_account_number']}}" class="form-control" placeholder="{{translate('account number')}}"
                                required>
                            </div>
                        </div>
                        <div class="col-md-3">
                           <div class="form-group">
                             ...
                             <input type="text" name="ifsc_code" value="{{$staffs['ifsc_code']}}" class="form-control" placeholder="{{translate('ifsc_code')}}"
                                required>
                            </div>
                        </div>
                     </div>
    ...
    <select name="branch_id" class="form-control" required>
        ...
        @foreach($branches as $key => $value)
                                    <option value="{{ $key }}" {{ $staffs->branch_id == $key ? 'selected' : '' }}>{{ $value }}</option>
                                @endforeach
                            </select>
                            </div>
                         </div>
                     ...
                     <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="balance" value="{{$staffs['balance']}}" class="form-control" placeholder="{{translate(' balance')}}"
                                    required>
                            </div>
                         </div>
                        <div class="col-md-3">
                            <div class="form-group">
                              ...
                              <input type="text" name="earn" value="{{$staffs['earn']}}" class="form-control" placeholder="{{translate('earn')}}"
                                 required>
                             </div> 
                         </div> 
                        <div class="col-md-3">
                           <div class="form-group">
                             ...
                             <input type="text" name="incentives" value="{{$staffs['incentives']}}" class="form-control" placeholder="{{translate('incentives')}}"
                                required>
                            </div>
                        </div>
                     </div>
